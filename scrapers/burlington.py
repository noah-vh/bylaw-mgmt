"""
Burlington By-laws PDF Scraper
"""
...
class BurlingtonScraper(BaseSupabaseScraper):
    """Burlington municipality scraper"""
    ...
    def find_pdf_links(self, html_content: str) -> List[Dict]:
        ...
        for link in soup.find_all('a', href=True):
            ...
            if (re.search(r'bylaw|by-law|policy|regulation|animal services', href, re.I) or 
                re.search(r'bylaw|by-law|policy|regulation|animal services', link_text, re.I)):
