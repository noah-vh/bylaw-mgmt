...
class OakvilleScraper(BaseSupabaseScraper):
    """Oakville municipality scraper"""
    
    def __init__(self, municipality_id: int):
        base_url = "https://www.oakville.ca"
        search_url = "https://www.oakville.ca/town-hall/by-laws-enforcement/"
    ...
    def find_pdf_links(self, html_content: str) -> List[Dict]:
        ...
        for link in soup.find_all('a', href=True):
            ...
            if (re.search(r'bylaw|by-law|policy|regulation|enforcement', href, re.I) or 
                re.search(r'bylaw|by-law|policy|regulation|enforcement', link_text, re.I)):
